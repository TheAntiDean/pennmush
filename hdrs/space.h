...
#define SDB_ATTR_NAME             "SPACE`SDB"
#define LOCATION_ATTR_NAME        "SPACE`LOCATION"
#define SPACE_ATTR_NAME           "SPACE"
#define CLASS_ATTR_NAME           "SHIP`CLASS"
#define CONSOLE_ATTR_NAME         "SHIP`SPACE`CONSOLES"
#define CONSOLE_USER_ATTR_NAME    "SHIP`USER"

#define ALLOCATE_ATTR_NAME        "SHIP`ALLOCATE"
#define ALLOCATE_DATA_NUMBER      21

#define BEAM_ATTR_NAME            "SHIP`WEAPON`BEAM"
#define BEAM_DATA_NUMBER          5
#define BEAM_ACTIVE_ATTR_NAME     "SHIP`WEAPON`BEAM`ACTIVE"
#define BEAM_NAME_ATTR_NAME       "SHIP`WEAPON`BEAM`NAME"
#define BEAM_RECYCLE_ATTR_NAME    "SHIP`WEAPON`BEAM`RECYCLE" 
#define BEAM_DAMAGE_ATTR_NAME     "SHIP`WEAPON`BEAM`DAMAGE"
#define BEAM_BONUS_ATTR_NAME      "SHIP`WEAPON`BEAM`BONUS"
#define BEAM_COST_ATTR_NAME       "SHIP`WEAPON`BEAM`COST"
#define BEAM_RANGE_ATTR_NAME      "SHIP`WEAPON`BEAM`RANGE"
#define BEAM_ARCS_ATTR_NAME       "SHIP`WEAPON`BEAM`ARCS"
#define BEAM_LOCK_ATTR_NAME       "SHIP`WEAPON`BEAM`LOCK"
#define BEAM_LOAD_ATTR_NAME       "SHIP`WEAPON`BEAM`LOAD"
#define MAX_BEAM_BANKS            20 

#define MISSILE_ATTR_NAME         "SHIP`WEAPON`MISSILE"
#define MISSILE_DATA_NUMBER       5
#define MISSILE_ACTIVE_ATTR_NAME  "SHIP`WEAPON`MISSILE`MISSILE_ACTIVE"
#define MISSILE_NAME_ATTR_NAME    "SHIP`WEAPON`MISSILE`MISSILE_NAME"
#define MISSILE_RECYCLE_ATTR_NAME "SHIP`WEAPON`MISSILE`MISSILE_RECYCLE"
#define MISSILE_DAMAGE_ATTR_NAME  "SHIP`WEAPON`MISSILE`MISSILE_DAMAGE"
#define MISSILE_WARHEAD_ATTR_NAME "SHIP`WEAPON`MISSILE`MISSILE_WARHEAD"
#define MISSILE_COST_ATTR_NAME    "SHIP`WEAPON`MISSILE`MISSILE_COST"
#define MISSILE_RANGE_ATTR_NAME   "SHIP`WEAPON`MISSILE`MISSILE_RANGE"
#define MISSILE_ARCS_ATTR_NAME    "SHIP`WEAPON`MISSILE`MISSILE_ARCS"
#define MISSILE_LOCK_ATTR_NAME    "SHIP`WEAPON`MISSILE`MISSILE_LOCK"
#define MISSILE_LOAD_ATTR_NAME    "SHIP`WEAPON`MISSILE`MISSILE_LOAD"
#define MAX_MISSILE_TUBES         20

#define ENGINE_ATTR_NAME          "SHIP`SYSTEM`ENGINE"
#define ENGINE_DATA_NUMBER        9

#define STRUCTURE_ATTR_NAME       "SHIP`SYSTEM`STRUCTURE"
#define STRUCTURE_DATA_NUMBER     12

#define POWER_ATTR_NAME           "SHIP`SYSTEM`POWER"
#define POWER_DATA_NUMBER         5

#define SENSOR_ATTR_NAME          "SHIP`SYSTEM`SENSOR"
#define SENSOR_DATA_NUMBER        17

#define SENSOR_LIST_ATTR_NAME     "SHIP`SYSTEM`SENSOR_LIST"
#define SENSOR_LIST_DATA_NUMBER   3
#define MAX_SENSOR_CONTACTS       30

#define SHIELD_ATTR_NAME          "SHIP`SYSTEM`SHIELD"
#define SHIELD_DATA_NUMBER        16

#define TECHNOLOGY_ATTR_NAME      "SHIP`SYSTEM`TECHNOLOGY"
#define TECHNOLOGY_DATA_NUMBER    9

#define MOVEMENT_ATTR_NAME        "SHIP`SYSTEM`MOVEMENT"
#define MOVEMENT_DATA_NUMBER      9

#define CLOAK_ATTR_NAME           "SHIP`SYSTEM`CLOAK"
#define CLOAK_DATA_NUMBER         6

#define TRANS_ATTR_NAME           "SHIP`SYSTEM`TRANS"
#define TRANS_DATA_NUMBER         7

#define TRACT_ATTR_NAME           "SHIP`SYSTEM`TRACT"
#define TRACT_DATA_NUMBER         6

#define COORDS_ATTR_NAME          "SHIP`SPACE`COORDS"
#define COORDS_DATA_NUMBER        9

#define COURSE_ATTR_NAME          "SHIP`SPACE`COURSE"
#define COURSE_DATA_NUMBER        17

#define MAIN_ATTR_NAME            "SHIP`SYSTEM`MAIN"
#define MAIN_DATA_NUMBER          5

#define AUX_ATTR_NAME             "SHIP`SYSTEM`AUX"
#define AUX_DATA_NUMBER           5

#define BATT_ATTR_NAME            "SHIP`SYSTEM`BATT"
#define BATT_DATA_NUMBER          5

#define FUEL_ATTR_NAME            "SHIP`SYSTEM`FUEL"
#define FUEL_DATA_NUMBER          3

#define STATUS_ATTR_NAME          "SHIP`SYSTEM`STATUS"
#define STATUS_DATA_NUMBER        10

#define IFF_ATTR_NAME			  "SHIP`SYSTEM`IFF"
