...
void
report_eng_power(void)
{
  static char buffer[BUFFER_LEN];

  snprintf(buffer, sizeof(buffer),
           "%s%s: %sEngineering Allocation Report%s : :                        "
           "                   : %s\n%sAllocation             EPS "
           "Power\n%s---------------------- "
           "--------------------------------------------------------%s\n",
  ...
  strncat(buffer,
          tprintf("  %s%-20.20s%s %10.10s: %4.4s %s\n", ANSI_CYAN,
                  ...
                  ansi_rainbow_scale(sdb[n].alloc.tactical, 35)),
          sizeof(buffer) - 1);
  strncat(buffer,
          tprintf("  %s%-20.20s%s %10.10s: %4.4s %s\n", ANSI_CYAN,
                  ...
                  ansi_rainbow_scale(sdb[n].alloc.operations, 35)),
          sizeof(buffer) - 1);
...
void
report_helm_power(void)
{
  static char buffer[BUFFER_LEN];
  register int i;

  snprintf(buffer, sizeof(buffer),
           "%s%s: %sHelm/Navigation Allocation Report%s : :                    "
           "                   : %s\n%sAllocation             EPS "
           "Power\n%s---------------------- "
           "--------------------------------------------------------%s\n",
           ANSI_HILITE, ANSI_BLUE, ANSI_YELLOW, ANSI_BLUE, ANSI_NORMAL,
...
void
report_tact_power(void)
{
  static char buffer[BUFFER_LEN];

  snprintf(buffer, sizeof(buffer),
           "%s%s: %sTactical/Weapon Allocation Report%s : :                    "
           "                   : %s\n%sAllocation             EPS "
           "Power\n%s---------------------- "
           "--------------------------------------------------------%s\n",
           ANSI_HILITE, ANSI_BLUE, ANSI_YELLOW, ANSI_BLUE, ANSI_NORMAL,
...
void
report_ops_power(void)
{
  static char buffer[BUFFER_LEN];

  snprintf(buffer, sizeof(buffer),
           "%s%s: %sOperations Allocation Report%s : :                         "
           "                   : %s\n%sAllocation             EPS "
           "Power\n%s---------------------- "
           "--------------------------------------------------------%s\n",
           ANSI_HILITE, ANSI_BLUE, ANSI_YELLOW, ANSI_BLUE, ANSI_NORMAL,
...
void
report_shield_power(void)
{
  static char buffer[BUFFER_LEN];
  register int i;

  snprintf(buffer, sizeof(buffer),
           "%s%s: %sShield Allocation Report%s : :                             "
           "                   : %s\n%sAllocation             EPS "
           "Power\n%s---------------------- "
           "--------------------------------------------------------%s\n",
           ANSI_HILITE, ANSI_BLUE, ANSI_YELLOW, ANSI_BLUE, ANSI_NORMAL,
...
void
report_sensor_power(void)
{
  static char buffer[BUFFER_LEN];

  snprintf(buffer, sizeof(buffer),
           "%s%s: %sEW Systems Allocation Report%s : :                         "
           "                   : %s\n%sAllocation             EPS "
           "Power\n%s---------------------- "
           "--------------------------------------------------------%s\n",
           ANSI_HILITE, ANSI_BLUE, ANSI_YELLOW, ANSI_BLUE, ANSI_NORMAL,
